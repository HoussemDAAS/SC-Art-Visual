          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2 space-y-16">
              ...
              <div className="fade-in-up">
                <h2 className="mb-6">Why Choose This Pack?</h2>
                <div className="space-y-4 text-[#E5E5E5] text-lg leading-relaxed" dir="rtl">
                  <p>{product.description}</p>
                  <p>
                    خلاص للساعات الطويلة في الأنيماشن ولا تخلّص ديزاينرز غاليين كل مرة. 
                    الباك هذا يعطيك موشن غرافيك بروفيشنال بجودة عالية، حاجة لو تعملها من الصفر بروحك توفاك آلاف الدنانير.
                  </p>
                  <p>
                    مناسب لكل صنّاع المحتوى، السوشيال ميديا مانجرز، ومونتورز الفيديو. كان تعمل رييلز، تيك توك، ولا يوتيوب شورتس - الباك هذا فيه كل شي تحتاجو.
                  </p>
                </div>
              </div>
